import { Docker } from '@/components/mx/modal-system/components/docker';
import { ModalContainer } from '@/components/mx/modal-system/components/modal-container';
import React, { createContext, JSX, ReactNode, useContext, useMemo, useState } from 'react';
import { ModalContextValue, ModalOptions, SubDialogStateMap, UseSubDialogReturn } from './types/use-modal-system.types';
            ...
            {modals.map((modal) => (
                <ModalContainer
                    ...
                    onClose={() => {
                        ...
                        if (modal.onClose) return modal.onClose();
                        close(modal.id);
                    }}
