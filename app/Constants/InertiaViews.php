...
class InertiaViews
{
    const S_P_I = "shop/product/index";
    const S_P_S = "shop/product/show";
    const A_P_I = "admin/product/index";
    ...
    const A_C_S = "admin/category/show";
    const A_C_C = "admin/category/create";
